...
<%
					flag=0              
			    elseif rs_class("ClassName")="普三甲" or rs_class("ClassName")="普三乙" then
%>
	<script language="JavaScript">
		alert("\n您無須填寫！");
		history.go( -1 )
...
<%
					...
					'--aaron add 註解
					'--sql1="Update Login Set LoginDate=getdate() "
...
<h2 align="center">
  <font face="標楷體" size=5>台中市明德女中選修課程選擇登入帳號<br></font>
  <font face="標楷體" color=blue size=4>本次填寫之時間期限<%=startday%> 至 <%=endday%><br></font>
</h2>
