<%
	'Response.Redirect "../SelectNCourse/default.asp"
%>
...
function checkvalue() { 
	...
	<body onload="document.login.id.focus()">
		<H2 align="center">
			<font face="標楷體" size="6">台中市明德女中選修課程線上選擇</font><FONT face="標楷體" size="5"><br>
		</H2></FONT>
		<table border="0" width="100%" ID="Table1">
			<tr>
				<td width="100%">
			<tr>
				<td width="100%" align="center" height="60"><FONT face="標楷體" size="5"><A href="http://md1.mdhs.tc.edu.tw/SelectForCourse/login.asp">於校內選擇課程</A></FONT></td>
			</tr>
			<tr>
				<td width="10%" align="center" height="15"></td>
			</tr>
			<tr>
				<td width="100%" align="center" height="60"><FONT face="標楷體" size="5"><A href="http://md1.mdhs.tc.edu.tw/SelectForCourse/login.asp">於校外選擇課程</A></FONT></td>
			</tr>
			</td>
			<TR>
				<td width="0%"></td>
