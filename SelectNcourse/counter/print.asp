...
<%
    ...
    '------------------------------   
    if (course1=true or course2=true or course3=true or course4=true or course5=true or course6=true or course7=true) and bus>0 and bus<16 and busstopid<>"" then  
		Response.Write("<tr>")
		...
		Response.Write("</tr>")
		flag=1
    elseif (course1=true or course2=true or course3=true or course4=true or course5=true or course6=true or course7=true) and (bus=0 or bus=16) then  
		Response.Write("<tr>")
		Response.Write("<td><p align='center'><font color=purple size=4>請按此按鈕列印同意書--------></font>")
		Response.Write("<input type='button' style='font-size: 16 pt; color:#FF0000; font-weight:bold' onclick='Danger_type();window.print();' value='列印' name='printsubmit'>")
		Response.Write("</td>")
		...
		'if (course1=true or course2=true or course3=true or course4=true or course5=true) and bus>0 then
			flag=0
		elseif (course1=true or course2=true or course3=true or course4=true or course5=true or course6=true or course7=true) and bus>0 and bus<16 and (busstopid="" or isnull(busstopid)) then
			flag=-1
		end if
    end if
    Response.Write("</div>")
...
if flag=1 then
	...
	if gradeyear=1 then 
		...
		elseif left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普一甲數學加強班(星期一)</span></strong></font></td>")
				else
			...
			elseif right(classname,1)="乙" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普一乙數學加強班(星期二)</span></strong></font></td>")
				else
		...
		elseif left(classname,1)="幼" or left(classname,1)="美" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高一高職家事類數學 A班(星期三)</span></strong></font></td>")
			else
			...
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高一高職商業類數學 B班(星期三)</span></strong></font></td>")
			else
	...
	elseif gradeyear=2 then
		...
		if left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二甲數學加強班(星期三)</span></strong></font></td>")
				else
					Response.Write("<input type='checkbox' name='Subject2' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普二甲數學加強班(星期三)</span></td>")
				end if 
			elseif right(classname,1)="乙" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二乙數學加強班(星期四)</span></strong></font></td>")
				else
		...
		elseif left(classname,1)="幼" or left(classname,1)="美" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高二高職家事類數學 A班(星期四)</span></strong></font></td>")
			else
			...
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高二高職商業類數學 B班(星期二)</span></strong></font></td>")
			else
		...
		if classname="高三11" or classname="高三12" or classname="高三13" or classname="高三14" or classname="高三15" or classname="高三16" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高三高職家事類數學 A班(星期一)</span></strong></font></td>")
			else
			...
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高三高職商業類數學 B班(星期一)</span></strong></font></td>")
			else
	...
	if gradeyear=1 and left(classname,1)<>"普" and identity<>"pro" then 
		...
		if course3=true then
			Response.Write("<input type='checkbox' name='Subject3' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高一高職英文基礎班(星期一)</span></strong></font></td>")
		else
			Response.Write("<input type='checkbox' name='Subject3' disabled><span style='font-size: 14pt; font-family: 標楷體'> 高一高職英文基礎班(星期一)</span></td>")
		end if 
		if (i mod 2)=1 then 
			Response.Write("<td bgcolor=#EBEBEB>")
		else 
		...
		Response.Write("<p align='left'><font color='#000000'><span style='font-size: 14pt; font-family: 標楷體'> 段考平均為60分(含)以下者 </span></font></td>")
		Response.Write("</tr>")
	end if 
	...
	if gradeyear=1 then 
		...
		elseif left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course4=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普一甲英文加強班(星期二)</span></strong></font></td>")
				else
					Response.Write("<input type='checkbox' name='Subject4' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普一甲英文加強班(星期二)</span></td>")
				end if 
			elseif right(classname,1)="乙" then 
				if course4=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普一乙英文加強班(星期五)</span></strong></font></td>")
				else
			...
			if course4=true then
				Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高一高職英文加強班(星期一)</span></strong></font></td>")
			else
			...
			Response.Write("<p align='left'><font color='#000000'><span style='font-size: 14pt; font-family: 標楷體'> 段考平均為60分以上者 </span></font></td>")
			Response.Write("</tr>")
		end if 
	elseif gradeyear=2 then
		if left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course4=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二甲英文加強班(星期二)</span></strong></font></td>")
				else
					Response.Write("<input type='checkbox' name='Subject4' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普二甲英文加強班(星期二)</span></td>")
				end if 
			elseif right(classname,1)="乙" then 
				if course4=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二乙英文加強班(星期二)</span></strong></font></td>")
				else
		...
		if course4=true then
			Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高三高職英文加強班(星期五)</span></strong></font></td>")
		else
		...
		Response.Write("<p align='left'><font color='#000000'><span style='font-size: 14pt; font-family: 標楷體'> 為積極準備四技統測，提升英文實力之高三職學生 </span></font></td>")
		Response.Write("</tr>")
	end if 
	...
	if gradeyear=1 and (left(classname,1)="廣" or left(classname,1)="畫") and identity<>"pro" then 
		...
		if course5=true then
			Response.Write("<input type='checkbox' name='Subject5' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 基礎素描班(星期四)</span></strong></font></td>")
		else
	...
	elseif gradeyear=2 and left(classname,1)="廣" then 
		...
		if course7=true then
			Response.Write("<input type='checkbox' name='Subject7' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 麥克筆班(星期三)</span></strong></font></td>")
		else
	...
	elseif bus=6 then
		...
		Response.Write("<tr>")
	elseif bus=7 then
		Response.Write("<td bgcolor=#FBFAFA><span style='font-size: 14pt; font-family: 標楷體'>您選擇的是<u>　新社國中(8人座)　</u>。</span></td>")
		Response.Write("</tr>")
		Response.Write("<tr>")
	elseif bus=8 then
	...
	elseif bus=13 then
		...
		Response.Write("<tr>")
	elseif bus=14 then
		Response.Write("<td bgcolor=#FBFAFA><span style='font-size: 14pt; font-family: 標楷體'>您選擇的是<u>　39號車B線　</u>。</span></td>")
		Response.Write("</tr>")
		Response.Write("<tr>")
	elseif bus=15 then
		...
		Response.Write("<tr>")
	elseif bus=16 then
		Response.Write("<td bgcolor=#FBFAFA><span style='font-size: 14pt; font-family: 標楷體'>您選擇的是<u>　溪霸線　</u>。</span></td>")
		Response.Write("</tr>")
		Response.Write("<tr>")
	end if
	...
	Response.Write("<tr>")
	Response.Write("<td><p align='center'><span style='font-size: 16pt; font-family: 標楷體'> 中　　華　　民　　國　九　十　九　年　二　月　　　　日</span></td>")
	Response.Write("</tr>")
