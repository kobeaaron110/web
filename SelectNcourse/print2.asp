...
if flag=1 then
	...
	Response.Write("<td><p align='center'><span style='font-size: 18pt; font-family: 標楷體'> " & rs1("SchoolYear") & "學年度第" & rs1("Semester") & "學期夜間輔導晚自習活動<strong>家長同意書</strong></span></td>")
	Response.Write("</tr>")
	Response.Write("<tr>")
	...
	Response.Write("<p align='center'><font color='#000000'><span style='font-size: 16pt; font-family: 標楷體'>基礎測驗成績</span></font>")
	Response.Write("</td>")
	Response.Write("</tr>")
  if course1=true then
	Response.Write("<tr>")
  ...
  if course2=true then
	...
	if gradeyear=1 then 
		if left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普一甲數學加強班(星期四)</span></strong></font></td>")
				'else
			...
			elseif right(classname,1)="丙" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普一丙數學加強班(星期四)</span></strong></font></td>")
				'else
		...
		elseif left(classname,1)="幼" or left(classname,1)="美" then 
			if course2=true then
				if rs("ProgramID2")=999 then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高一數學加強班(星期一)　<strong>《備取名額》</span></strong></font></td>")
				else
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高一數學加強班(星期一)</span></strong></font></td>")
				end if 
			'else
	...
	elseif gradeyear=2 then 
		...
		elseif left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二甲數學複習班(星期二)</span></strong></font></td>")
				'else
				'	Response.Write("<input type='checkbox' name='Subject2' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普一甲數學加強班(星期一)</span></td>")
				end if 
			elseif right(classname,1)="乙" then 
			...
			elseif right(classname,1)="丙" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二丙數學複習班(星期五)</span></strong></font></td>")
				'else
				'	Response.Write("<input type='checkbox' name='Subject2' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普一乙數學加強班(星期三)</span></td>")
				end if 
			end if 
		elseif left(classname,1)="幼" or left(classname,1)="美" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高二高職數學班(星期三)</span></strong></font></td>")
			'else
			'	Response.Write("<input type='checkbox' name='Subject2' disabled><span style='font-size: 14pt; font-family: 標楷體'> 高一高職家事類數學 A班(星期三)</span></td>")
			end if 
		else
	...
	elseif gradeyear=3 then
		...
		elseif left(classname,1)="普" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高三學測班(星期五)</span></strong></font></td>")
				'else
				'	Response.Write("<input type='checkbox' name='Subject2' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普二甲數學加強班(星期三)</span></td>")
				end if 
		elseif left(classname,1)="幼" or left(classname,1)="美" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高三高職數學班(星期四)</span></strong></font></td>")
			'else
	...
	Response.Write("<p align='left'><font color='#000000'><span style='font-size: 14pt; font-family: 標楷體'> 　基礎測驗數學成績　" & rs("Score1") & " </span></font></td>")
	Response.Write("</tr>")
  end if 
  ...
  if course3=true then
	...
	if gradeyear=1 then 
		if left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普一甲英文加強班(星期一)</span></strong></font></td>")
				'else
			...
			elseif right(classname,1)="丙" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普一丙英文加強班(星期五)</span></strong></font></td>")
				'else
			...
			if course3=true then
				if rs("ProgramID4")=999 then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 高一高職英文加強班(星期二)　<strong>《備取名額》</span></strong></font></td>")
				else
			...
			Response.Write("<p align='left'><font color='#000000'><span style='font-size: 14pt; font-family: 標楷體'> 　基礎測驗英文成績　" & rs("Score2") & " </span></font></td>")
			Response.Write("</tr>")
		end if 
	elseif gradeyear=2 then 
		if identity="pro" then
		...
		elseif left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二甲英文複習班(星期三)</span></strong></font></td>")
				'else
				'	Response.Write("<input type='checkbox' name='Subject4' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普一甲英文加強班(星期二)</span></td>")
				end if 
			elseif right(classname,1)="乙" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二乙英文複習班(星期三)</span></strong></font></td>")
				'else
				'	Response.Write("<input type='checkbox' name='Subject4' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普一乙英文加強班(星期五)</span></td>")
				end if 
			elseif right(classname,1)="丙" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject4' checked disabled><font color='blue'><strong><span style='font-size: 14pt; font-family: 標楷體'> 普二丙英文複習班(星期三)</span></strong></font></td>")
				'else
				'	Response.Write("<input type='checkbox' name='Subject4' disabled><span style='font-size: 14pt; font-family: 標楷體'> 普一丙國英加強班(星期一)</span></td>")
				end if 
			end if 
	...
	Response.Write("<tr>")
	Response.Write("<td><p align='center'><span style='font-size: 16pt; font-family: 標楷體'> 中　　華　　民　　國　101　年　8　月　　　　日</span></td>")
	Response.Write("</tr>")
