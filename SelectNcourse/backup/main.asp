...
<%
	...
	elseif (gradeyear=2 or gradeyear=3) and left(classname,1)="普" then 
		Response.Write("<td colspan=2> 參加科目：　　　　　　　　　　　　　　<a href='10001英數課業暨夜間輔導實施要點(高中版).doc' target='_blank'>下載 夜間輔導暨晚自習實施要點</td>")
	elseif gradeyear=1 or gradeyear=2 then 
		Response.Write("<td colspan=2> 參加科目：　　　　　　　　　　　　　　<a href='10001英數課業暨夜間輔導實施要點(高職版).doc' target='_blank'>下載 夜間輔導暨晚自習實施要點</td>")
	...
	if gradeyear=2 then
		...
		elseif left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked> 普二甲數學複習班(星期四)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject2'> 普二甲數學複習班(星期四)</td>")
				end if 
			elseif right(classname,1)="乙" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked> 普二乙數學複習班(星期二)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject2'> 普二乙數學複習班(星期二)</td>")
				end if 
			elseif right(classname,1)="丙" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked> 普二丙數學複習班(星期二)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject2'> 普二丙數學複習班(星期二)</td>")
				end if 
			end if 
	...
	if gradeyear=2 then
		...
		elseif left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject3' checked> 普二甲國英複習班(星期二)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject3'> 普二甲國英複習班(星期二)</td>")
				end if 
			elseif right(classname,1)="乙" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject3' checked> 普二乙國英複習班(星期一)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject3'> 普二乙國英複習班(星期一)</td>")
				end if 
			elseif right(classname,1)="丙" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject3' checked> 普二丙國英複習班(星期四)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject3'> 普二丙國英複習班(星期四)</td>")
				end if 
			end if 
			if (i mod 2)=1 then 
				Response.Write("<td bgcolor=#EBEBEB>")
			...
			if course3=true then
				Response.Write("<input type='checkbox' name='Subject3' checked> 高二高職英文複習班(星期二)</td>")
			else
				Response.Write("<input type='checkbox' name='Subject3'> 高二高職英文複習班(星期二)</td>")
			end if 
			if (i mod 2)=1 then 
				Response.Write("<td bgcolor=#EBEBEB>")
			else 
	...
	if (gradeyear=2 or gradeyear=3) and (left(classname,1)="廣" or left(classname,1)="畫") and identity<>"pro" then 
		i=i+1
		Response.Write("<tr>")
		if (i mod 2)=1 then 
			Response.Write("<td bgcolor=#EBEBEB>")
		...
		if course5=true then
			Response.Write("<input type='checkbox' name='Subject5' checked  onclick='pic_basic();'> 素描基礎班(星期一)</td>")
		else
			...
			Response.Write("<input type='checkbox' name='Subject5' " & flag_picb & "  onclick='pic_basic();'> 素描基礎班(星期一)</td>")
		end if 
		if (i mod 2)=1 then 
			Response.Write("<td bgcolor=#EBEBEB>")
		else 
	...
	if (gradeyear=2 or gradeyear=3) and (left(classname,1)="廣" or left(classname,1)="畫") and identity<>"pro" then 
		...
		if course6=true then
			Response.Write("<input type='checkbox' name='Subject6' checked  onclick='pic_adv();'> 素描進階班(星期一)</td>")
		else
			if course5=true then
				flag_pica="disabled"
			else
			...
			Response.Write("<input type='checkbox' name='Subject6' " & flag_pica & "  onclick='pic_adv();'> 素描進階班(星期一)</td>")
		end if 
		if (i mod 2)=1 then 
			Response.Write("<td bgcolor=#EBEBEB>")
		else 
	...
	'if gradeyear=3 and (left(classname,1)="商" or left(classname,1)="資" or left(classname,1)="貿") and identity<>"pro" then 
	'	i=i+1
	'	Response.Write("<tr>")
	'	if (i mod 2)=1 then 
	'		Response.Write("<td bgcolor=#EBEBEB>")
	...
	'		Response.Write("<input type='checkbox' name='Subject7' checked> 經濟總複習班(星期五)</td>")
	'	else
	'		Response.Write("<input type='checkbox' name='Subject7'> 經濟總複習班(星期五)</td>")
	'	end if 
	'	if (i mod 2)=1 then 
	'		Response.Write("<td bgcolor=#EBEBEB>")
	'	else 
	'		Response.Write("<td bgcolor=#FBFAFA>")
	'	end if 
	'	Response.Write("<p align='left'><font color='#000000'><span style='font-size: 12pt'> 商資貿科 </span></font></td>")
	'	Response.Write("</tr>")
	
	Response.Write("</table>")
	
	Response.Write("<br><td> 交通選擇：（請選擇）　　　　　　　　　<a href='10001學期夜間輔導校車時間表.xls' target='_blank'>下載 夜輔校車路線站名一覽表</a></td>")
	...
	if busval=4 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='4' name='Bus' checked  onclick='Bus_Stop8();'> 8號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='4' name='Bus'  onclick='Bus_Stop8();'> 8號車</td>")
	end if
	if busval=5 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='5' name='Bus' checked  onclick='Bus_Stop9();'> 9號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='5' name='Bus'  onclick='Bus_Stop9();'> 9號車</td>")
	end if
	if busval=6 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='6' name='Bus' checked  onclick='Bus_Stop11();'> 11號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='6' name='Bus'  onclick='Bus_Stop11();'> 11號車</td>")
	end if
	Response.Write("</tr>")
	Response.Write("<tr>")
	if busval=7 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='7' name='Bus' checked  onclick='Bus_Stop11B();'> 11B號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='7' name='Bus'  onclick='Bus_Stop11B();'> 11B號車</td>")
	end if
	if busval=8 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='8' name='Bus' checked  onclick='Bus_Stop15();'> 15號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='8' name='Bus'  onclick='Bus_Stop15();'> 15號車</td>")
	end if
	if busval=9 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='9' name='Bus' checked  onclick='Bus_Stop16();'> 16號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='9' name='Bus'  onclick='Bus_Stop16();'> 16號車</td>")
	end if
	if busval=10 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='10' name='Bus' checked  onclick='Bus_Stop20();'> 20號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='10' name='Bus'  onclick='Bus_Stop20();'> 20號車</td>")
	end if
	if busval=11 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='11' name='Bus' checked  onclick='Bus_Stop30();'> 30號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='11' name='Bus'  onclick='Bus_Stop30();'> 30號車</td>")
	end if
	if busval=12 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='12' name='Bus' checked  onclick='Bus_Stop33();'> 33號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='12' name='Bus'  onclick='Bus_Stop33();'> 33號車</td>")
	end if
	if busval=13 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='13' name='Bus' checked  onclick='Bus_Stop36();'> 36號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='13' name='Bus'  onclick='Bus_Stop36();'> 36號車</td>")
	end if
	Response.Write("</tr>")
	Response.Write("<tr>")
	if busval=14 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='14' name='Bus' checked  onclick='Bus_Stop39();'> 39號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='14' name='Bus'  onclick='Bus_Stop39();'> 39號車</td>")
	end if
	if busval=15 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='15' name='Bus' checked  onclick='Bus_Stop39B();'> 39B號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='15' name='Bus'  onclick='Bus_Stop39B();'> 39B號車</td>")
	end if
	if busval=16 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='16' name='Bus' checked  onclick='Bus_Stop39C();'> 39C號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='16' name='Bus'  onclick='Bus_Stop39C();'> 39C號車</td>")
	end if
	if busval=17 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='17' name='Bus' checked  onclick='Bus_Stop42();'> 42號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='17' name='Bus'  onclick='Bus_Stop42();'> 42號車</td>")
	end if
	if busval=18 then
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='18' name='Bus' checked  onclick='Bus_Stop60();'> 60號車</td>")
	else
		Response.Write("<td bgcolor=#FBFAFA><input type='radio' value='18' name='Bus'  onclick='Bus_Stop60();'> 60號車</td>")
	end if
	Response.Write("</tr>")
	Response.Write("</table>")
