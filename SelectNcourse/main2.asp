...
<!-- 來源
\\203.68.204.6\e$\程式\101年\8月\1010813\SelectNCourse\main.asp
-->
...
<%
	...
	Response.Write("<tr>")
	' aaron
	'Response.Write("<td colspan=2><span style='font-size: 15pt; font-family: 標楷體'> 班級：" & replace(replace(rs("ClassName"),"二","三"),"一","二") & "　　　　　學號：" & Account & "　　　　　　姓名：" & rs("Name") & "</span></td>") 'aaron
	...
	Response.Write("<td><font color='#008080'><span style='font-size: 12pt'><INPUT type='text' value='" & rs("tel") & "' name='Telephone" & cnt & "' maxlength='20' id='Telephone' onkeyup='numcheck(this.id,this)' ></span></font></td>")
	Response.Write("</tr>")
	Response.Write("<tr>")
    Response.Write("<td bgcolor='#008080'><p align='center'><font color='#FFFFFF'><span style='font-size: 12pt'>請填寫行動電話</span></font></td>")
	Response.Write("<td><font color='#008080'><span style='font-size: 12pt'><INPUT type='text' value='" & rs("mobile") & "' name='Mobile" & cnt & "' maxlength='10' id='Mobile' onkeyup='numcheck(this.id,this)' ></span></font></td>")
	Response.Write("</tr>")
	Response.Write("<tr>")
	Response.Write("<td><br></td>")
	Response.Write("</tr>")
	...
	if left(classname,1)="普" then 
		Response.Write("<td colspan=2> 參加科目：　　　　　　　　　　　　　　<a href='10101英數課業暨夜間輔導實施要點(高中版).doc' target='_blank'>下載 夜間輔導暨晚自習實施要點</td>")
	else
		Response.Write("<td colspan=2> 參加科目：　　　　　　　　　　　　　　<a href='10101英數課業暨夜間輔導實施要點(高職版).doc' target='_blank'>下載 夜間輔導暨晚自習實施要點</td>")
	end if
	...
	if gradeyear=1 then
		...
		elseif left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked> 普一甲數學複習班(星期二)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject2'> 普一甲數學複習班(星期二)</td>")
				end if 
			elseif right(classname,1)="乙" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked> 普一乙數學複習班(星期二)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject2'> 普一乙數學複習班(星期二)</td>")
				end if 
			elseif right(classname,1)="丙" then 
				if course2=true then
					Response.Write("<input type='checkbox' name='Subject2' checked> 普一丙數學複習班(星期五)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject2'> 普一丙數學複習班(星期五)</td>")
				end if 
			end if 
		elseif left(classname,1)="幼" or left(classname,1)="美" then
			...
			if course2=true then
				if rs("ProgramID2")=999 then
					Response.Write("<input type='checkbox' name='Subject2' checked disabled> 高一高職數學班(星期三)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject2' checked> 高一高職數學班(星期三)</td>")
				end if
			else
				if flag2="額滿" then
					Response.Write("<input type='checkbox' name='Subject2' disabled> 高一高職數學班(星期三)　　<strong>《" & flag2 & "》</strong></td>")
				else
					Response.Write("<input type='checkbox' name='Subject2'> 高一高職數學班(星期三)</td>")
				end if
			end if 
		else
			if course2=true then
				...
				if flag1="額滿" then
					Response.Write("<input type='checkbox' name='Subject2' disabled> 高一高職數學班(星期三)　　<strong>《" & flag1 & "》</strong></td>")
				else
					Response.Write("<input type='checkbox' name='Subject2'> 高一高職數學班(星期三)</td>")
				end if
			end if 
	...
	elseif gradeyear=2 then
		...
		elseif left(classname,1)="普" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked> 高二學測班(星期五)</td>")
			else
				Response.Write("<input type='checkbox' name='Subject2'> 高二學測班(星期五)</td>")
			end if 
		elseif left(classname,1)="幼" or left(classname,1)="美" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked> 高二高職數學班(星期四)</td>")
			else
				Response.Write("<input type='checkbox' name='Subject2'> 高二高職數學班(星期四)</td>")
			end if 
		else
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked> 高二高職數學班(星期四)</td>")
	...
	elseif gradeyear=3 then
		...
		elseif left(classname,1)="普" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked> 高三學測班(星期五)</td>")
			else
				Response.Write("<input type='checkbox' name='Subject2'> 高三學測班(星期五)</td>")
			end if 
		elseif left(classname,1)="幼" or left(classname,1)="美" then 
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked> 高三高職數學班(星期四)</td>")
			else
				Response.Write("<input type='checkbox' name='Subject2'> 高三高職數學班(星期四)</td>")
			end if 
		else
			if course2=true then
				Response.Write("<input type='checkbox' name='Subject2' checked> 高三高職數學班(星期四)</td>")
	...
	if gradeyear=1 then
		...
		elseif left(classname,1)="普" then 
			if right(classname,1)="甲" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject3' checked> 普二甲英文複習班(星期三)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject3'> 普二甲英文複習班(星期三)</td>")
				end if 
			elseif right(classname,1)="乙" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject3' checked> 普二乙英文複習班(星期三)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject3'> 普二乙英文複習班(星期三)</td>")
				end if 
			elseif right(classname,1)="丙" then 
				if course3=true then
					Response.Write("<input type='checkbox' name='Subject3' checked> 普二丙英文複習班(星期三)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject3'> 普二丙英文複習班(星期三)</td>")
				end if 
			end if 
			if (i mod 2)=1 then 
				Response.Write("<td bgcolor=#EBEBEB>")
			...
			if course3=true then
				if rs("ProgramID1")=999 then
					Response.Write("<input type='checkbox' name='Subject3' checked disabled> 高二高職英文複習班(星期四)</td>")
				else
					Response.Write("<input type='checkbox' name='Subject3' checked> 高二高職英文複習班(星期四)</td>")
				end if
			else
				if flag3="額滿" then
					Response.Write("<input type='checkbox' name='Subject3' disabled> 高二高職英文複習班(星期四)　　<strong>《" & flag3 & "》</strong></td>")
				else
	...
	' --------------------------- 交通 ---------------------------
	Response.Write("<br><td> 交通選擇：（請選擇）　　　　　　　　　<a href='10101夜間輔導校車時間表.xls' target='_blank'>下載 夜輔校車路線站名一覽表</a></td>")
