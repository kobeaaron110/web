...
function Bus_Stop6B()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='6B' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop6C()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='6C' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop8()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='8' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop11()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='11' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop11B()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='11B' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop20B()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='20B' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop39B()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='39B' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop39C()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='39C' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop60()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='60' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop9B()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='9B' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop9C()
{
	...
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='9C' order by 站序")
	while not rs1.eof
		response.write "t='" & rs1("代碼") & " " & rs1("站名") & "';" & chr(13)
		response.write "v='" & rs1("代碼") & "';" & chr(13)
	%>
...
function Bus_Stop60_()
{
	//$("#Select1 option[index='0']").remove();
	$("#Select1 option").remove();
	//$("#Select1").prepend("<option value='0'>請選擇</option>");
	$("#Select1").append("<option value='0'>Please select station</option>");
	//$("#Select1").append("<option value='Value'>Text</option>");
	
	<%
	set rs1=conn.Execute("Select * from 站名資料 Where 車號='60' order by 站序")
	while not rs1.eof
		response.write "$('#Select1').append('<option value=" & rs1("代碼") & ">" & rs1("代碼") & " " &rs1("站名") & "</option>');"
