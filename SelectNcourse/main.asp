...
<%
	...
	elseif (gradeyear=1 or gradeyear=2) and left(classname,1)="普" then 
		Response.Write("<td colspan=2> 參加科目：　　　　　　　　　　　　　　<a href='10102夜間輔導實施要點(普科一二版).doc' target='_blank'>下載 夜間輔導暨晚自習實施要點</td>")
	elseif gradeyear=1 or gradeyear=2 then 
		Response.Write("<td colspan=2> 參加科目：　　　　　　　　　　　　　　<a href='10102夜間輔導實施要點(高一二職版).doc' target='_blank'>下載 夜間輔導暨晚自習實施要點</td>")
	elseif gradeyear=3 then 
		Response.Write("<td colspan=2> 參加科目：　　　　　　　　　　　　　　<a href='10102夜間輔導實施要點(高三職版).doc' target='_blank'>下載 夜間輔導暨晚自習實施要點</td>")
	end if
	...
	'Response.Write("<td bgcolor=#FBFAFA><input id='BusCode12' type='radio' value='12' name='Bus'  onclick='Bus_Stop20B();' disabled > 20B號車</td>")
	Response.Write("</tr>")
	Response.Write("</table>")
